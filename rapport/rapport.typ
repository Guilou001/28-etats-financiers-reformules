...
*Résultat en une phrase.* Sur 26 trimestres et 39 industries, l'affaire elle-même rapporte de *11,5 % à 13,1 %* par an en médiane selon la lecture. L'emprunt n'ajoute que *+0,18 point* en médiane, ou *−0,88 point* selon la façon de traiter les soldes entre sociétés d'un même groupe, et la part médiane du rendement qui lui revient va de *+0,26 % à −5,25 %*. Ce sont six médianes prises sur les 39 industries, et non des bornes : dix-neuf industries font mieux dans chaque lecture.

_Summary in English. A Nissim-Penman reformulation of Statistics Canada's quarterly aggregate balance sheet and income statement (table 33-10-0225, 327 360 rows, 66 quarters, 40 industries), separating operating from financing returns. Eight of the items the reformulation adds up are only published from January 2020, so the calculation covers 26 quarters and 1 040 industry-quarters, and the other 1 600 are reported as dropped. Operating return runs from 11.5 % to 13.1 % a year at the median, depending on the reading. The median contribution of leverage is +0.18 point in one reading and −0.88 point in the other, and the median share of return on equity it carries runs from +0.26 % to −5.25 %. These are medians over the 39 industries and not bounds: nineteen industries do better in each reading. Both accounting identities hold on all 1 040 rows: 1 million dollars, one unit of the last digit the table publishes, and 0.008 points of annual return on the reformulation identity._
