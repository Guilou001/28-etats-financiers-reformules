#set document(title: "Séparer le rendement de l'activité et l'effet de l'endettement", author: "Guillaume Vaudescal")
#set page(
  paper: "a4",
...
#align(center)[
  #block(width: 100%)[
    #text(size: 18pt, weight: "bold")[Séparer le rendement de l'activité et l'effet de l'endettement]
    #v(0.6em)
    #text(size: 10pt, fill: luma(70))[Guillaume Vaudescal · 2026-09-04 · #link("https://github.com/Guilou001/28-etats-financiers-reformules")[Guilou001/28-etats-financiers-reformules]]
  ]
]
#v(1.2em)
